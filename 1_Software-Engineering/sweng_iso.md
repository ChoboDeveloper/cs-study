...
* **기능성(Functionality)** : 명시된 요구와 내재된 요구를 만족하는 기능을 제공
  * 적합성
  * 정확성
  * 상호운영성
  * 보안성
* **신뢰성(Reliability)** : 사용자가 오류를 방지할 수 있도록 하는 SW제품의 능력
  * 성숙성
  * 오류 허용성
  * 복구성
  * 순응성

* **사용성(Usability)** : 소프트웨어를 쉽게 사용할 수 있는 정도
  * 학습성
  * 운용성
  * 친밀성
* **효율성(Efficiency)** : 최소의 작업으로 요구되는 기능을 수행하는 정도
  * 시간 반응성
  * 자원 활용성
* **유지보수성(Maintainability)** : 소프트웨어 제품의 변경
  * 변경성
  * 시험성
  * 안정성
